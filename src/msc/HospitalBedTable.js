...
import HospitalBeds from '../data/hospitalbeds.json'
import {COLUMNS} from '../components/HospitalBedColumn'
...
*/
export const  FilterHospitalBedsTable = () => {
    const columns = useMemo(() => COLUMNS, [])
    const data = useMemo(() => HospitalBeds, [])
