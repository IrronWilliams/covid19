...
import TopCountyDeaths from '../data/topcountydeaths.json'
import {COLUMNS} from '../components/CountyDeathsColumn'
...
*/
export const  FilterCountyDeathsTable = () => {
    const columns = useMemo(() => COLUMNS, [])
    const data = useMemo(() => TopCountyDeaths, [])
